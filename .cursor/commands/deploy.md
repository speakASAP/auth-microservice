...
pull github repos using ssh statex "cd auth-microservice && git pull && cd ../nginx-microservice && git pull && docker exec nginx-microservice nginx -t && docker exec nginx-microservice nginx -s reload"
...
Run: ssh statex "cd nginx-microservice && ./scripts/blue-green/deploy.sh auth-microservice"
