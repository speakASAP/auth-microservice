#!/usr/bin/env node
/**
 * Ensures shop-assistant has internal:shop-assistant:service for billing
 * callback Auth RS256 receivers.
 *
 * Apply:
 *   kubectl exec -n statex-apps deploy/auth-microservice -c app -- \
 *     node scripts/seed-shop-assistant-service-role.js --apply \
 *     --confirm-db-mutation=SERVICE_PRINCIPAL
 */

const CONTRACT = 'shop-assistant-service-role-seed.v1';
const DB_CONFIRMATION = 'SERVICE_PRINCIPAL';

const APP_NAME = 'shop-assistant';
const ROLE_SCOPE = 'internal';
const ROLES = [
  {
    name: 'service',
    description: 'Machine access for payments billing callbacks and storefront S2S',
  },
  {
    name: 'admin',
    description: 'Machine admin access for shop-assistant internal routes',
  },
];
