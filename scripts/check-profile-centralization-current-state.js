...
function main() {
  ...
  const checks = {
    ...
    consumerRefreshEvidence: includesAll(completionAudit + status + state, [
      ...
      'Payments main is clean at 1544d93',
      'npm run check:hosted-auth passed',
      'Aukro main is clean at c521762',
      'Cliplot main is clean at 7bfb686',
      'Owner-approved authenticated admin UI/session proof',
      'Owner-approved synthetic browser-session wallet fetch or Auth-owned mutation contract before write surfaces',
    ]),
