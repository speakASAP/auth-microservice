# Copilot Instructions — `auth-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/auth-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/auth-microservice.git`, branch `main`.
