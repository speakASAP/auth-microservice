...
deploy_preflight() {
  ...
  # EP-005 W3. Must also be listed in configmap_vars below: envsubst uses an explicit allow-list,
  # so an unlisted variable is left in the manifest as the literal string "${RABBITMQ_URL}".
