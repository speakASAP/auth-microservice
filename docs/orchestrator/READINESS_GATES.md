...
- Contract validation result or `No Auth contract change`.
...
- Auth contract smoke check when JWT/API/OAuth/magic-link/RBAC behavior changed.
- Confirmation that no secrets, tokens, passwords, or raw production user data were captured.
