...
- `cliplot`: clean, but checkout mutation remains guarded and approval-gated.
...
- `[MISSING: production-safe schema migration path]`
...
- `[MISSING: owner-approved deployment window for Auth API after implementation]`
