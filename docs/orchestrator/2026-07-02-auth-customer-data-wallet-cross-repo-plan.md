...
| C1 Cliplot plan                                        | dirty-worktree-blocked; runtime-gated | Cliplot coordinator | Docs/guarded plan only | Clean worktree, selector/session/PII approvals, approved field mapping, and guest fallback decisions | Cliplot owner | After dirty work is resolved |
