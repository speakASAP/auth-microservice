...
- [x] 10.86 FlipFlop auth-subject smoke cleanup source guard hardened in branch `codex/goal10-auth-subject-smoke-cleanup` commit `6fe9e07`; runtime cleanup token projection and branch/merge decision remain gated.
...
- `[MISSING: owner-approved Rent-a-box route/onboarding migration and later backfill/product-code migration before replacing local auth]`
