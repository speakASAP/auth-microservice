...
| C1 Cliplot plan                    | approval-gated-browser-session-fetch-source-prepared; live-fetch-and-submit-gated | Cliplot coordinator | `cliplot/docs/auth-wallet-checkout-contract.md`, `cliplot/implementation-goals/GOAL-10-auth-wallet-checkout-readiness.execution-plan.md`, `cliplot/scripts/auth-wallet-checkout-readiness.js`, `cliplot/reports/validation/GOAL-10-auth-wallet-checkout-readiness.md` | approved synthetic bearer/window before live fetch evidence; checkout submit remains separately gated | later |
...
- `[MISSING: Rent-a-box focused API test runner / pytest environment for adapter/dependency tests]`
...
- `[MISSING: Cliplot approved synthetic bearer/window for live browser-session fetch evidence; checkout submit remains separately gated]`
